...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="kontakt.jsp">Kontakt </a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="dodawanieKlientow.jsp">Dodaj klienta</a></li>
                    </ul>
                </div>
            </div>
        </nav>
  <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Lista klientów</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">
                            
								     <p class ="text-white-75 font-weight-light mb-5">Liczba klientów: ${lkl.size()}</p>
   ...
   <tr>
      <td>id_klienta</td> <td>imie</td> <td>nazwisko</td>
   </tr>
    <c:forEach var="el" items="${lkl}">
   <tr>
      <td>${el.id_klienta}</td> <td>${el.imie}</td> <td> ${el.nazwisko}</td>
   </tr>
   </c:forEach> 
</table>
