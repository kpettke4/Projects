            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="kontakt.jsp">Kontakt </a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="dodawanieModeli.jsp">Dodaj model</a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Lista modeli</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">
                        <h2 class="text-white-75 font-weight-light mb-5">Lista modeli</h2>
                             <p class="text-white-75 font-weight-light mb-5">Aktualnie w naszej ofercie posiadamy części dla: ${lmo.size()} modeli.</p>
								

            					<ul class="navbar-nav ml-auto my-2 my-lg-0">
               <c:forEach var="el" items="${lmo}">
              <a href="listaModeli?id_modelu=${el.id_modelu}"><p class="text-white-75 font-weight-light mb-5">  ${el.rocznik} ${el.marka} ${el.kolor}</p></a>
                </c:forEach>
