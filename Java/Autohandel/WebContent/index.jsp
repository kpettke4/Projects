            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="listaModeli">Lista Modeli</a></li>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Obejrzyj części</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">Posiadamy w ofercie wiele części. Na pewno znajdziesz coś dla siebie</p>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="listaCzesci.jsp">Zobacz części</a>
                    </div>
                </div>
            </div>
        </header>
