...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="kontakt.jsp">Kontakt </a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="listaCzesci">Lista Części</a></li>
                           <li class="nav-item"><a class="nav-link js-scroll-trigger" href="dodawanieStanu.jsp">Usuń niedostępne</a></li>
  ...
  <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Lista stanu</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">
                            
								     <p class ="text-white-75 font-weight-light mb-5">Aktualnie niedostępne: ${lst.size()}</p>
   ...
   <tr>
      <td>numer</td> <td>nazwa</td> <td>dostepnosc</td> <td>Data sprzedazy</td> <td> Data dostawy</td>
   </tr>
    <c:forEach var="el" items="${lst}">
   <tr>
      <td>${el.numer}</td> <td>${el.nazwa}</td> <td> ${el.dostepnosc}</td><td> ${el.data_sprzedazy}</td><td> ${el.data_dostawy}</td>
   </tr>
   </c:forEach> 
</table>
