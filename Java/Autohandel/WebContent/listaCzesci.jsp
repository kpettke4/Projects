...
<body>
               ...
               <a class="navbar-brand js-scroll-trigger" href="index.jsp">Autohandel VAG</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="kontakt.jsp">Kontakt </a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="dodawanieCzesci.jsp">Dodaj część</a></li>
                    </ul>
                </div>
            </div>
        </nav>
  <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Lista części</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">
                            
								     <p class ="text-white-75 font-weight-light mb-5">Liczba części: ${lcz.size()}</p>
   ...
   <tr>
      <td>Numer</td> <td>Model</td> <td>Nazwa</td>
   </tr>
    <c:forEach var="el" items="${lcz}">
   <tr>
      <td>${el.numer}</td> <td>${el.model}</td> <td> ${el.nazwa}</td>
   </tr>
   </c:forEach> 
</table>
