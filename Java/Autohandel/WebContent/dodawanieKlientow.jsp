...
<body>
  ...
  <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Dodaj klienta</h1>
    ...
    <h3>Czy chcesz dodać nowego klienta?</h3>
    <form action = "Obsluga" method = "get">
   		id_klienta: <input type = "text" name = "id_klienta" id="id_klienta"> <br/>
        imie: <input type = "text" name = "imie" id="imie"> <br/>
        nazwisko: <input type = "text" name = "nazwisko" id="nazwisko"> <br/>
        telefon: <input type = "text" name = "telefon" id="telefon"> <br />
        adres: <input type = "text" name = "adres" id="adres"> <br />
  
        <br />
        <input type = "submit" value = " Dodaj klienta " /><p>${wynik_klient}</p>
</form>


<div class="widok">
    <h3>Tu możesz usunąć klienta</h3>
    <form action = "Obsluga" method = "get">
        Klienci:
        <select name="klient_usun">
            <c:forEach var="el" items="${lkl}">
                <option value="${el.id_klienta}">${el.id_klienta} </option>
            </c:forEach>
        </select>
        <input type = "submit" value = " Usuń " /><p>${usun_kl}</p>
    </form>
