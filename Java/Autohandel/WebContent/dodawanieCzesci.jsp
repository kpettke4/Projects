...
<body>
  ...
  <header class="masthead">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">Dodaj część</h1>
    ...
    <h3>Czy chcesz dodać nową część?</h3>
    <form action = "Obsluga" method = "get">
   		numer: <input type = "text" name = "numer" id="numer"> <br/>
        część: <input type = "text" name = "nowa_część" id="nowa_część"> <br/>
        nazwa: <input type = "text" name = "nazwa" id="nazwa"> <br/>
        model: <input type = "text" name = "model" id="model"> <br />
        opis: <input type = "text" name = "opis" id="opis"> <br />
        typ_silnika: <input type = "text" name = "typ_silnika" id="typ_silnika"> <br />
        stan: <input type = "text" name = "stan" id="stan"> <br />
         cena: <input type = "text" name = "cena" id="cena"> <br />
        <br />
        <input type = "submit" value = " Dodaj część " /><p>${wynik_część}</p>
</form>
<br>

    <h3>Tu możesz usunąć część</h3>
    <form action = "Obsluga" method = "get" >
        Części:
        <select name="czesc_usun">
            <c:forEach var="el" items="${lcz}">
                <option value="${el.numer}">${el.numer}</option>
            </c:forEach>
        </select>
        <input type = "submit" value = " Usuń " /><p>${usun_cz}</p>
    </form>
    </div>
    </div>
    </div>
